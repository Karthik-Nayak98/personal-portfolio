...
const Header = ({ title }) => {
  return (
    <div className='relative w-fit px-8 pb-2 text-2xl md:px-12 md:text-3xl lg:my-3 lg:px-16 lg:text-4xl'>
      <h2 className='text-light font-bold capitalize'>{title}</h2>
